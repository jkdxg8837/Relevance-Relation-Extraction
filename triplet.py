...
class EntityDict:
    ...
    def multi_entity_to_idx(self, entity_id: str) -> int:
        output_array = []
        for _idx in range(len(entity_id)):
            output_array.append(self.entity2idx[entity_id[_idx]])
        return output_array
...
class EntityDict_with_multilabel:
